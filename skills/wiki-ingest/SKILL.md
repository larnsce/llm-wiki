...
- Queue classification is inline (REQ-076 retired): propose each file's
  slug and inferred type in-session while scanning the queue. Wiki-state
  judgments (supersedes, conflicts) stay at the checkpoint, which reads
  the wiki
