...
- ## Provenance Properties (ingested pages)
	...
	- reliability:: high | medium | low - REQUIRED on ingested pages (hand-written pages omit it). Rates the QUALITY of the page's sources; assessed per claim and rolled up: the page value is the MINIMUM across its claims.
