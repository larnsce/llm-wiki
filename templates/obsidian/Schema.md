...
- **Rule 16 Paper-Hub Hygiene** (REQ-260): wiki/papers/<slug> hubs carry type:: paper-hub, the six sections (Manuscript, Literature drawn on, Data, Open questions, Draft decisions, AI use), and link every child page (the export-walk guarantee); the agent-log child keeps the canonical six-column table header; structure and reachability only, content is editorial and never auto-fixed
